...
ln -s $TMP_JARS_DIR/hudi-spark*.jar $TMP_JARS_DIR/spark.jar
ln -s $TMP_JARS_DIR/hudi-utilities-bundle*.jar $TMP_JARS_DIR/utilities.jar
ln -s $TMP_JARS_DIR/hudi-utilities-slim*.jar $TMP_JARS_DIR/utilities-slim.jar
