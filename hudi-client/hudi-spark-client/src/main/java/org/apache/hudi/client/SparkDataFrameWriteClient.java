...
public class SparkDataFrameWriteClient extends AbstractHoodieClient implements CleanDelegate {
  ...
  public Dataset<HoodieInternalWriteStatus> upsert(Dataset<Row> inputDf, String instantTime) {
    HoodieBaseTable table = getTableAndInitCtx(WriteOperationType.UPSERT, instantTime);
    table.validateUpsertSchema();
    preWrite(instantTime, WriteOperationType.UPSERT, table.getMetaClient());
    HoodieWriteMetadata<Dataset<HoodieInternalWriteStatus>> result = table.upsert(context, instantTime, inputDf);
