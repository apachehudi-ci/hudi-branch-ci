...
public abstract class HoodieBaseTable<I, K, O> implements SchemaAware, Serializable {
  private static final Logger LOG = LogManager.getLogger(HoodieBaseTable.class);
  protected final HoodieWriteConfig config;
  protected final HoodieTableMetaClient metaClient;
  protected final SerializableConfiguration hadoopConfiguration;
  ...
  protected HoodieBaseTable(HoodieWriteConfig config, HoodieEngineContext context, HoodieTableMetaClient metaClient) {
    this.config = config;
