...
[![Build Status](https://dev.azure.com/xushiyan/apache-hudi-ci/_apis/build/status/apachehudi-ci.hudi-mirror?branchName=master)](https://dev.azure.com/xushiyan/apache-hudi-ci/_build/latest?definitionId=1&branchName=master)
