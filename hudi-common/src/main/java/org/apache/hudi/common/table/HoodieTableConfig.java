...
public class HoodieTableConfig extends HoodieConfig {
  ...
  public String getStoragePath() {
    String storagePath = getString(HOODIE_STORAGE_PATH);

    return StringUtils.isNullOrEmpty(storagePath)
        || StorageStrategy.DEFAULT.value.equals(getStorageStrategy())
        ? this.getBasePath() : storagePath;
  }

  public String getStorageStrategy() {
    return getString(HOODIE_STORAGE_STRATEGY_CLASS_NAME);
  }
