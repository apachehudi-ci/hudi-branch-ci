...
public final class HoodieMetadataConfig extends HoodieConfig {
  ...
  public static final Set<String> SUPPORTED_TABLE_SERVICE_MANAGER_EXECUTION_ACTIONS = new HashSet<>(Arrays.asList(
      ActionType.compaction.name(), ActionType.logcompaction.name(), ActionType.clean.name(), "archive"));

  public static final Set<String> SUPPORTED_TABLE_SERVICE_MANAGER_SCHEDULE_ACTIONS = new HashSet<>(Arrays.asList(
