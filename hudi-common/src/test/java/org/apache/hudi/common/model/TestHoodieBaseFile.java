...
public class TestHoodieBaseFile {
  ...
  void createFromExternalFileStatus() {
    ...
    HoodieFileStatus inputFileInfo = new HoodieFileStatus(
    ...
    HoodieBaseFile hoodieBaseFile = new HoodieBaseFile(inputFileInfo);
  ...
  private void assertFileGetters(HoodieFileStatus fileInfo, HoodieBaseFile hoodieBaseFile,
    ...
    assertEquals(fileInfo, hoodieBaseFile.getFileStatus());
  }
}
